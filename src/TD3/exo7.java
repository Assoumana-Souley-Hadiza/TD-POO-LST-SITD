...
public class exo7 {
    public static void main(String[] args){
        Patron patron=new Patron("Ali","Mohamed",15000);
        System.out.println(patron.toString());
        TravailleurComission travailleurComission=new TravailleurComission("amine","karim",1200,500,2);
       travailleurComission.gain();
        System.out.println(travailleurComission.toString());
        TravailleurHoraire travailleurHoraire=new TravailleurHoraire("leila","ait",200,3);
